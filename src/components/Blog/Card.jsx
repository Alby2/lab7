...
const Card = () => {
    return (
        <div className="h-fit pb-0  rounded-xl z-10 my-10 bg-white">
            ...
            <div className="relative ">
                <img src={banner8} alt="" className="h-[500px] rounded-t-xl w-full" />
                <div className="bg-primary w-24 text-center absolute rounded-md -top-10 left-10">
                    <div className="px-1 py-1">
                        <div className="text-2xl text-white font-bold">24</div>
                        <div className="text-lg text-white font-bold">Juillet</div>
                        <div className="text-2xl text-white font-bold">2023</div>
                ...
                <div className="flex mt-0 justify-end space-x-3 absolute right-5 top-5 ">
                    <div className="cursor-pointer bg-primary/25 px-3 py-1 rounded-lg">{"J'aime"}</div>
                    <div className="cursor-pointer bg-primary/25 px-3 py-1 rounded-lg">{"Partager"}</div>
                </div>
            </div>
            ...
            <div className="  px-5  rounded-b-2xl py-5  ">
