...
const Apropos = () => {
    return (
        <div className="lg:mx-20 mt-20 mb-10">
            <div className="grid grid-cols-12  items-center">
                <div className="xl:col-span-7 lg:col-span-8 md:col-span-8 col-span-12 mt-6 mx-14">
                    <span className="w-fit  pb-2 pr-5 text-4xl text-black font-black  border-b-4 border-primary-2">
                        Pourquoi nous ?
                    </span>
                    <br />
                    <p className="text-2xl font-normal mt-10 text-gray-700">
            ...
            <div className="flex justify-center mt-5 ">
                <div className="px-10 py-1 border-2 text-lg font-semibold w-fit cursor-pointer border-black hover:text-white hover:font-semibold hover:bg-black uppercase ">En savoir plus sur nous</div>
            </div>
        </div>
    )
}
