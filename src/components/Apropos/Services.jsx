    ...
    return (
        <div className=" mx-14 mt-20 ">
            <div className="grid grid-cols-3 mb-20">
                <div className="p-10 pb-2 text-center w-full hover:shadow-2xl hover:bg-white hover:translate-y-3 cursor-pointer ">
                ...
                <div className="p-10 pb-2 text-center w-full bg-white hover:shadow-2xl hover:bg-white hover:translate-y-3 cursor-pointer hover:transition-shadow ">
                    <div className="flex justify-center">
                ...
                <div className="p-10 pb-2 text-center w-full hover:shadow-2xl hover:bg-white hover:translate-y-3 cursor-pointer hover:transition-shadow ">
                    <div className="flex justify-center">
