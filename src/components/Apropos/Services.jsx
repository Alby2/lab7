    ...
    return (
        <div className="  mt-20 ">
            <div className="grid grid-cols-12 mb-20">
                ...
                <div className="col-span-12 lg:col-span-4 2xl:col-span-4 p-10 pb-2 text-center w-full hover:shadow-2xl hover:bg-white  cursor-pointer ">
                ...
                <div className="col-span-12 lg:col-span-4 2xl:col-span-4 p-10 pb-2 text-center w-full  hover:shadow-2xl hover:bg-white  cursor-pointer hover:transition-shadow ">
                    <div className="flex justify-center">
