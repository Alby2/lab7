    ...
    return (
        <>
            <div className="bg-home bg-fixed min-w-screen min-h-screen bg-cover pb-10">
                <Navbar />
                <div className="grid grid-cols-12 pt-28 items-center">
                    <div className="lg:col-span-6 col-span-12 -mt-28 ">
            ...
            <div className="lg:mx-24">
                ...
                <img src="/lampe_mission.svg" className=" w-full h-28 -mt-10 md:h-36 lg:h-52" alt="" />
